...
def cleanDataFrame():
    ...
    DataStore.df_cleaned["actividades_extracurriculares"] = DataStore.df_cleaned["actividades_extracurriculares"].apply(
    lambda x: x if len(x) > 0 else ['n/a'] if isinstance(x, list) else ['n/a'])
    """
        NORMALIZANDO
    # DataStore.df_cleaned["actividades_extracurriculares"]=DataStore.df_cleaned["actividades_extracurriculares"].apply(eval)
    # DataStore.df_cleaned["actividades_extracurriculares"] = DataStore.df_cleaned["actividades_extracurriculares"].apply(
    ...
    DataStore.df_cleaned.loc[DataStore.df_cleaned['horas_estudio'] == 0, 'horas_estudio'] = DataStore.df_cleaned["horas_estudio"].mean()
    ...
    print(DataStore.df_cleaned.head(10))
